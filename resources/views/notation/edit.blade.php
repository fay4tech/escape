...
@section('content')
    <div class="container text-light">
        ...
        <div class="col-12">
            <div class="col-3"></div>
            <div class="col-9">
                {!! Form::open(['route' => ['notation.update', $text['id']], 'method' => 'PUT', 'id' => 'edit' ]) !!}
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="text" name="text" rows="10" aria-describedby="commentHelpBlock" class="form-control">{{ $text->text }}</textarea>
                    </div> 
                    <div class="form-group">
