...
@auth
@section('tiny')
    @include('layouts.partials._tiny_'.config('app.locale'))
@endsection
@php
...
@section('content')
    ...
    <div class="container text-light">
        ...
        {{ csrf_field() }}
        <div class="fixed-bottom" style="padding-bottom: 50px; padding-left: 16px">
        ...
        <div class="alert alert-info text-center mb-0 ">
            ...
            <h4 class="alert-heading"><strong>@lang('Notre expérience!')</strong></h4>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
                ...
                {!! form_row($form->playDate, $options = ['value' => $playDate]) !!}
                <spam class="mx-1"> </spam>
        ...
        <div>
            <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="correction" name="correction"
                @if($room->correction == 1)
                    checked
                @endif
                >
                <label class="custom-control-label pb-1" for="correction">Corrigé</label>
            </div>
            <br><br><br>
        </div>
